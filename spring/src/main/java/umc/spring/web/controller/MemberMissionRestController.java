...
public class MemberMissionRestController {
    ...
    public ApiResponse<MemberMissionResponseDTO.progressMissionListDTO> getProgressMissionList(@PathVariable("memberId") Long memberId,@RequestParam(name = "page") Integer page) {
    ...
    public ApiResponse<MemberMissionResponseDTO.changeToCompletedMissionDTO> patchChangeToCompletedMissionDTO(@PathVariable("missionId") Long missionId, @PathVariable("memberId") Long memberId) {
